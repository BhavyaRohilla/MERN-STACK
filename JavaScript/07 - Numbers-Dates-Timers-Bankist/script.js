...
const account1 = {
  ...
  movementsDates: [
    '2025-07-14T21:31:17.178Z',
    '2025-07-13T07:42:02.383Z',
    '2025-07-12T09:15:04.904Z',
    '2025-07-10T10:17:24.185Z',
    '2025-07-10T14:11:59.604Z',
    '2025-07-14T17:01:17.194Z',
    '2025-07-15T23:36:17.929Z',
...
/* Topic - 1 converting and checking number
console.log(23 === 23.0);

// 1/10 = 0.1 , 10/3 = 3.33333333
...
console.log(451568657484876453874867489974981894861567896187861874896n);
console.log(BigInt(526564));

// Operations
console.log(10000n + 10000n);
console.log(2564651564531685464456n * 10000000000n);
// console.log(Math.sqrt(16n));

const huge = 2028978454984564895468513n;
const num = 23;
...
console.log(new Date('Aug 02 2025 18:05:41'));
console.log(new Date('December 24, 2025'));
console.log(new Date(account2.movementsDates[0]));

console.log(new Date(2097, 10, 19, 15, 23, 6));
console.log(new Date(2037, 10, 31));

console.log(new Date(0));
console.log(new Date(3 * 24 * 60 * 60 * 1000));
console.log(new Date(45 + 89 - 9));
*/
...
const days1 = calcDaysPassed(new Date(2037, 3, 14), new Date(2037, 3, 28));
console.log(days1);
*/
...
const pizzaTimer = setTimeout(
  (ing1, ing2) =>
    console.log(`Here is your tasty pizza with ${ing1} and ${ing2}`),
  3000,
  ...ingridients
);
console.log('waiting......');
